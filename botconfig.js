module.exports = {
  ...
  Token: process.env.Token || "OTYyNzg5NDE0OTI3NDcwNjIy.YlMphA.EpmixxxmVdvPxF8E4yc6dvWSJ4A", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "962789414927470622", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "wVm02TDniOEN3SE3EYNrxQzggBaCdDo9", //Discord Client Secret
  ...
  CookieSecret: "kidara123", //A Secret like a password
  IconURL:
  ...
  Website: process.env.Website || "https://mako-bot.cf", //Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
